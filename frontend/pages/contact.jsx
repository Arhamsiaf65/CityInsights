...
function Contact() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-blue-50 to-purple-100 px-4 py-12">
      <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 bg-white shadow-xl rounded-3xl p-10 md:p-16 border border-gray-100">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6 text-gray-700">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h2 className="text-lg font-semibold text-yellow-400">Office Address</h2>
                <p>2nd Floor, Media Hub Plaza, Sahiwal, Punjab, Pakistan</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <HiMail className="text-yellow-400 text-2xl mt-1" />
              <div>
            ...
            <div className="flex items-start gap-3">
              <HiPhone className="text-yellow-400 text-2xl mt-1" />
              <div>
            ...
            <div className="flex items-start gap-3">
              <HiClock className="text-yellow-400 text-2xl mt-1" />
              <div>
                <h2 className="text-lg font-semibold text-yellow-400">Office Hours</h2>
                <p>Mon - Fri: 9am – 5pm</p>
              </div>
            </div>
          </div>
        ...
        {/* Contact Form */}
        <form className="space-y-6 bg-gray-50 p-8 rounded-2xl shadow-inner border border-gray-200" onSubmit={handleSubmit}>
          <div>
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-blue-700 to-purple-600 text-white py-3 rounded-md font-semibold hover:opacity-90 transition-all shadow-md"
          >
            Send Message
          </button>
        </form>
